...
<head>
	...
	function showJoinForm(){
		...
		$('div#loginForm').css('display', 'none');
		$('div#res10Form').css('display', 'none');
	}
	...
	function backJoinForm(){
		$('div#joinForm').css('display', 'none');
		$('div#res10Form').css('display', 'block');
	}
...
<body>
	...
	<!-- Top 10 Restaurant -->
	<div id = "res10Form">
		<h2 align = center><b>Top 10 Restaurant</b></h2>
		<table class = "table">
			<thead>
				<tr id = "adapt_center">
					<th scope = "col">Num</th>
			...
			<thead>
			<c:forEach var = "row" items="${topten}">
				<tr>
					<th scope = "row" id = "adapt_center">${row.res_num}</td>
